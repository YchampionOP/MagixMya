  ...
  run: async (client, message, args, cmduser, text, prefix) => {
    ...
    try {
      if (args[0]) {
        ...
        .setThumbnail(client.user.displayAvatarURL())
.setColor(es.color)
.setFooter("Hero_Bot | Made by: ZeeXp#1533", client.user.displayAvatarURL())
.setTitle(`Information about the  <a:blue_yes:905842248695046165>`)
.addField("<a:blue_yes:905842248695046165> **__My Features__**",
`>>> **58+ Systems**, like: <:Twitter:912596352746291231> **Twitter-** & <:YouTube:912596468186103880> **Youtube-Auto-Poster** 
...
.addField("<a:867324408308695070:892077506860040233> **Ping**", `>>>  <:875933762972692510:912944567706333196>:**\`${Math.round(Date.now() - message.createdTimestamp)}ms\`
     <:875933754382749746:912944567937019904> **Api Latency:** \`${client.ws.ping}ms\``)
...
.setFooter(`Hero_Bot | Made by: ZeeXp#1533\nTo see command Descriptions and Information, type: ${config.prefix}help [CMD NAME]`, client.user.displayAvatarURL())
          ...
          let embed1 = new Discord.MessageEmbed()
            ...
            .setFooter(`Hero_Bot | Made by: BROKARONAGAMING#9999\nTo see command Descriptions and Information, type: ${config.prefix}help [CMD NAME]`, client.user.displayAvatarURL())
            ...
            .setFooter(`Hero_Bot | Made by: ZeeXp#15339\nTo see command Descriptions and Information, type: ${config.prefix}help [CMD NAME]`, client.user.displayAvatarURL())
